...
const (
	...
	EnvResourceByPod       = "DOSLAB_IO_GPU_RESOURCE_BY_POD"
	EnvResourceByContainer = "DOSLAB_IO_GPU_RESOURCE_BY_CONTAINER"
	EnvResourceTotal       = "DOSLAB_IO_GPU_RESOURCE_BY_TOTAL"
